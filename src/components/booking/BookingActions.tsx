...
export function BookingActions({ bookingId, currentStatus, isInstructor }: BookingActionsProps) {
    ...
    return (
        <>
            ...
            {/* Confirm button - Only instructor, only for pending */}
...
{/* Complete button - Only instructor, only for confirmed */ }
{
...
{/* No Show button - Only instructor, only for confirmed */ }
{
    isInstructor && currentStatus === BookingStatus.confirmed && (
        <Button
            size=\"sm\"
...
{/* Cancel button - Both parties, for pending or confirmed */ }
{
